...
|---|---|---|---|
| `features.orchestration` | `KANDEV_FEATURES_ORCHESTRATION` | off | Experimental Orchestrator: workspace coordination, central assistant capabilities, assignments, conversations and managed work. |
